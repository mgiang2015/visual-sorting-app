...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      ...
      <Header sortTypes={sortTypes} setSortTypes={setSortTypeToggleReady} setInputArray={setInputToggleReady} isReady={isReady} setIsReady={setIsReady} setRunning={setRunningToggleReady} />
      <p>{displayStr}</p>
